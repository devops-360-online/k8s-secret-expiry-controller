...
import (
	...
	"github.com/devops-360-online/k8s-secret-expiry-controller/controllers"
...
func init() {
	...
	utilruntime.Must(expiryv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6e0a9ae0.devops-360.online",
